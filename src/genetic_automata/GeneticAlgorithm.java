...
public class GeneticAlgorithm {
	...
	public static final int ELITISM_OFFSET = 20;
	
	// Probability of a DFA being selected for mutation.
	public static final double MUTATION_RATE = 0.05;
	
	// The number of iterations to run the genetic algorithm.
	...
	/*
	 * Implementation of roulette selection for choosing a DFA in the population.
	 * DFAs with higher fitness are selected more often.
	 */
